    ...
    <form className = 'listingform' onSubmit={e=>onSubmit(e)}>
        <div className = 'row'>
            ...
            <div className= 'listingform__section'>
                ...
                <div className= 'listingform__section'>
                    <label className= 'listingform__label' htmlFor = 'days_listed'>days_listed</label>
            ...
            <div className= 'col-1-of-6'>
                ...
                <div className= 'listingform__section'>
                    ...
                    <input className= 'listingform__input' name ='keywords' onChange={e=>onChange(e)} value ={keywords}/>
                </div>
                </div>
                <div className= 'col-1-of-6'>
                    <div className= 'listingform__section'>
