        ...
        images.push(
            <div key ={1} className='row'>
                ...
                <div className = 'col-1-of-3'>
                    {
                        listing.photo_2?(
                            <div className='listing__display'>
    ...
    return(
        ...
        <div className='row'>
            <div className = 'listingdetail__breadcrumb'>
                <Link className='listingdetail__breakcrumg__link' to ='/'>Home</Link> /{listing.title}
            </div>
        </div>
        <div className='row'>
            ...
            <div className='col-1-of-4'>
                <div className = 'listingdetail__display'>
                    <img className='listingdetial__display__image' src ={realtor.photo} alt=''/>
                </div>
                <h3 className='listingdetail__realtor'>{realtor.name}</h3>
                <p className='lsitingdetail__contact'>{realtor.phone}</p>
                <p className='lsitingdetail__contact'>{realtor.email}</p>
                <p className='lsitingdetail__about'>{realtor.description}</p>
            </div>
        </div>
        <div className='row'>
